...
このドキュメントは `mobile/` から公開 API（[ADR 0006](../../docs/adr/0006-public-quiz-api.md) /
[`docs/api/public-quiz-api.yaml`](../../docs/api/public-quiz-api.yaml)）を呼ぶための
追加レイヤの使い方をまとめる。
...
- [ADR 0006: Public Quiz API の仕様分離](../../docs/adr/0006-public-quiz-api.md)
- [ADR 0009: モバイル版の状態管理と層構造](../../docs/adr/0009-mobile-state-management.md)
- [`docs/api/public-quiz-api.yaml`](../../docs/api/public-quiz-api.yaml)
